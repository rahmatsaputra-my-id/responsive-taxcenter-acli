...
class home extends CI_Controller {
    ...
    public function registrasi()
    {
        ...
        $isi['query']           =$this->db
                                    ->select('p.id,p.status_pembayaran,p.tgl_register,c.nama_kursus,d.nama_lengkap,d.nama_depan,d.nama_belakang,e.gelombang,e.kelas,f.nama_ujian')
                                    ->join('data_kursus c','p.id_kursus = c.id','LEFT')
    ...
    public function rombelgelombang($id)
    {
        ...
        $isi['query']       =$this->db
                                  ->select('p.id_mahasiswa, p.status_pembayaran, d.npm, d.nama_lengkap, d.nama_depan, d.nama_belakang, c.gelombang, c.kelas')
                                  ->join('data_register d','p.id_mahasiswa = d.id','LEFT')
    ...
    public function gelombang()
    {
        ...
        $isi['query']       =$this->db
                                  ->select('p.id,p.gelombang,p.kelas,p.pj,p.id_kursus,c.nama_kursus')
								  ->join('data_kursus c','p.id_kursus = c.id','LEFT')
    ...
    public function export_rombelgelombang($id)
    {
        $isi['gelombang']   =True;
        $isi['query']       =$this->db
                                  ->select('p.id_mahasiswa, p.status_pembayaran, d.nama_lengkap, d.npm, d.nama_depan, d.nama_belakang, c.gelombang, c.kelas')
                                  ->join('data_register d','p.id_mahasiswa = d.id','LEFT')
                                  ->join('data_gelombang c','p.id_gelombang = c.id','LEFT')
                                  ->where('p.id_gelombang', $id)
								  ->order_by('nama_depan, nama_lengkap', 'ASC')
