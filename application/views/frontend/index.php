            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 additional-shop-info">
                    <ul class="list-unstyled list-inline">
                        <li><i class="fa fa-globe"></i><span><a href="https://www.activelearning-institute.com/">ActiveLearning Intitute</a></span></li>
                        <li><i class="fa fa-envelope-o"></i><span><a href="mailto:activelearning.inst@gmail.com">activelearning.inst@gmail.com</a></span></li>
                        <li><i class="fa fa-phone"></i><span>08-164-718-775</span></li>
                    </ul>
                </div>
                ...
                <div class="col-md-6 col-sm-6 additional-nav">
                    <ul class="list-unstyled list-inline pull-right">
                        <li><a href="<?=base_url().'index/login';?>">Masuk</a></li>
                        <li><a href="<?=base_url().'index/registrasi';?>">Daftar</a></li>
    ...
    <div class="pre-footer">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 col-sm-6 pre-footer-col" style=’text-align:justify;’>
            <h2>About Us</h2>
            
              <br>
              <p >Pelatihan dan pengembangan sumberdaya manusia merupakan dua konsep yang sama, yaitu untuk meningkatkan pengetahuan, keterampilan dan kemampuan. Titik fokus dari program pelatihan dan pengembangan adalah peningkatan kemampuan untuk melakukan pekerjaan yang spesifik pada saat ini, serta peningkatan pengetahuan dan keterampilan untuk melakukan pekerjaan pada masa yang akan datang, yang dilakukan untuk mengubah perilaku kerja.</p>
          ...
          <div class="col-md-4 col-sm-6 pre-footer-col">
            ...
            <address class="margin-bottom-40">
              ...
              <h5><b>Kantor Pusat ActiveLearning Institute</b></h5> 
              Jl. Kori Nuansa No.257 Jimbaran, Bali. <br><br>
              Telepon : &ensp;(+621) 816 471 8775  &emsp;(Johari) <br>
              &emsp;&emsp;&emsp;&emsp;: &ensp;(+621) 822 478 18127&ensp;(Lia) <br>
              &emsp;&emsp;&emsp;&emsp;: &ensp;(+621) 896 728 75728&ensp;(Aldo) <br>
              <!--Fax: 300 323 1456<br>-->
              Email&emsp;&ensp;: &ensp;<a href="mailto:activelearning.inst@gmail.com">activelearning.inst@gmail.com</a><br>
              No Rek &ensp;: &ensp;CV Bali Sejahtera (Bank Mandiri)<br>
              &emsp;&emsp;&emsp;&emsp;&emsp;145.00.2001.2007
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 col-sm-4 padding-top-10">
            Copyright © 2019 ActiveLearning - Institute. All rights reserved. 
          </div>
          <!-- END COPYRIGHT -->
          <!-- BEGIN PAYMENTS -->
          ...
          <div class="col-md-4 col-sm-4 text-right">
            <p class="powered">Powered by: <a href="https://www.activelearning-institute.com/">ActiveLearning - Institute</a></p>
          </div>
          <!-- END POWERED -->
        </div>
      </div>
