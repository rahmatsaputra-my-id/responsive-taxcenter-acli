            ...
            <div class="content-form-page">
              <div class="row">
                ...
                <div class="col-md-4 col-sm-4 pull-right">
                  <div class="form-info">
                    <h2><em>Informasi</em> Pendaftaran</h2>
				  ...
				  <div class="form-info">
                    ...
                    <p>Pembayaran dilakukan dengan transfer ke rekening : CV Bali Sejahtera (Bank Mandiri) 145.00.2001.2007 lalu konfirmasi ke contact person.</p>
					<!--<button type="button" class="btn btn-default">More details</button>-->
                  </div>
				  <div class="form-info">
                    <h2><em>Jam</em> Pelayanan Web</h2>
